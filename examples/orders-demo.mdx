...
The producer begins writing to `source.order_events.live`. Local endpoints are:

| Service | Address |
|---|---|
| Redpanda broker | `localhost:19092` |
| Redpanda Console | [http://localhost:18081](http://localhost:18081) |
...
status values, NULL identifiers, line totals, future events, uniqueness, and aggregate invariants.
