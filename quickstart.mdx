...
Direct mode is the default, so this file intentionally omits `[defaults].pipeline_mode`.
...
- [Kafka orders demo](/examples/orders-demo)
- [Local development UI](/cli/dev)
